...
""" VARIABLES """
embedding_model_name = "BAAI/bge-small-en-v1.5"  # Changed to BGE small
...
persist_directory = "./chroma_db_bge"  # New directory for BGE
collection_name = "rhl-project-bge"
...
""" UI """
st.header("LangChain BGE(BAAI/bge-small-en-v1.5) EMBEDDER GROK Demo")
st.markdown("""
